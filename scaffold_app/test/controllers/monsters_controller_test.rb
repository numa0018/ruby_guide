...
class MonstersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create monster" do
    assert_difference('Monster.count') do
      post monsters_url, params: { monster: { attrbute: @monster.attrbute, level: @monster.level, name: @monster.name } }
    end
  ...
  test "should update monster" do
    patch monster_url(@monster), params: { monster: { attrbute: @monster.attrbute, level: @monster.level, name: @monster.name } }
